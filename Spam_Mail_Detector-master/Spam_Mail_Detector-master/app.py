...
model = pickle.load(open("C:/Users/kusha/Downloads/Spam_Mail_Detector-master/Spam_Mail_Detector-master/spamModel.pkl", "rb"))
cv = pickle.load(open("C:/Users/kusha/Downloads/Spam_Mail_Detector-master/Spam_Mail_Detector-master/vectorizer.pkl", "rb"))
